...
6. left_stance, right_stance는 각각 120~180자 사이로, 핵심 입장만 짧고
   명료한 문장 2~3개로 써라(400~500자를 목표로 하던 이전 규칙은
   실제로 읽기엔 너무 길고 늘어진다는 사용자 피드백으로 폐기함). 배경
   설명이나 이유를 덧붙여 풀어 쓰지 말고, "무엇을 주장하는지"만 바로
