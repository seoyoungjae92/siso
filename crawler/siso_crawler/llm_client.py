...
좌/우 게시글 중 어느 하나라도 5·18민주화운동 등에 관한 특별법 등 관련
법령상 금지된 내용(5·18민주화운동의 발생 사실을 부정하거나, 북한군 개입설
등으로 왜곡·비방하는 주장 등)을 포함하고 있다면, 좌/우가 같은 쟁점을
다루는지와 무관하게 무조건 no_clear_issue를 true로 하고
title/left_stance/right_stance는 빈 문자열("")로 반환해라. 이런 내용은
어조만 순화해서 요약에 담아도 안 된다 — 아예 주제 자체를 만들지 마라.
