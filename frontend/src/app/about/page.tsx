    ...
    <div className="mx-auto w-full max-w-3xl px-4 py-10">
      ...
      <div className="space-y-8 text-[14px] leading-relaxed text-[#33322E]">
        <section>
          ...
          <p>
            {appName}는 좌 성향 커뮤니티(클리앙, 82쿡, 더쿠, 디시인사이드 민주당·이재명 계열
            갤러리 등)와 우 성향 커뮤니티(디시인사이드 보수 계열 갤러리, 루리웹 정치유머게시판 등)의
            정치 관련 게시글을 자동으로 모아 나란히 보여주는 서비스입니다.
        ...
        <section>
          ...
          <p>
            ...
            는 원문을 복제하지 않고 제목과 출처 링크를 모아 병렬로 비교하는 서비스입니다(주제
            합성을 위해 본문 앞부분 일부만 저장하며 화면에 그대로 노출하지 않습니다).
          </p>
        </section>
