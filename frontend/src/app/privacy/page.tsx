      ...
      <div className="space-y-8 text-[14px] leading-relaxed text-[#33322E]">
        ...
        <section>
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              <b>방문 통계(Vercel Web Analytics)</b>: 페이지 방문 수, 방문 페이지 등을
              집계합니다. 쿠키를 사용하지 않고 개별 방문자를 특정할 수 없는 익명 데이터로만
              수집됩니다.
            </li>
            <li>
              <b>이메일 주소(선택)</b>: 뉴스레터(&lsquo;주간 좌우 리포트&rsquo;) 구독을 신청한
              경우에만 수집합니다. 구독 신청 시 발송되는 확인 메일의 링크를 눌러야 실제 구독이
              시작됩니다(더블 옵트인).
            </li>
            <li>
        ...
        <section>
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>뉴스레터(&lsquo;주간 좌우 리포트&rsquo;) 발송 — 구독 신청자에 한함</li>
            <li>제보·건의 내용에 대한 답변 — 이메일을 남긴 경우에 한함</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              이메일 주소(뉴스레터): 구독 해지(수신거부) 시까지 보관하며, 모든 뉴스레터 메일 하단의
              수신거부 링크를 누르면 즉시 발송 대상에서 제외되고 더 이상 이용되지 않습니다.
            </li>
            <li>이메일 주소(제보·건의): 수집일로부터 90일 후 자동 파기</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            방문 통계 집계를 위해 Vercel Inc.의 Web Analytics를 이용합니다. 쿠키를 사용하지
            않고 개별 방문자를 식별할 수 없는 익명 데이터만 수집·처리됩니다. 또한 신고된
            댓글의 1차 검토를 위해 OpenRouter(여러 AI 모델을 하나의 API로 제공하는 서비스)
            및 그 경유 모델 사업자에 신고된 댓글 본문과 신고 사유를 전송합니다 — 무료
