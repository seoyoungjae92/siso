      ...
      <div className="space-y-8 text-[14px] leading-relaxed text-[#33322E]">
        ...
        <section>
          ...
          <p>
            ...
            댓글의 1차 검토를 위해 Anthropic, PBC(Claude API)에 신고된 댓글 본문과 신고
            사유를 전송합니다 — 이 처리 결과는 운영자의 검토를 돕는 참고용 힌트로만
            쓰이며, 게시물을 자동으로 삭제·차단하지 않습니다. 이 외에 개인정보 처리를
            외부에 위탁하고 있지 않으며, 위탁 범위가 추가로 늘어날 경우 사전에 이 방침에
            반영하여 고지합니다.
          </p>
        </section>
