      ...
      <div className="space-y-8 text-[14px] leading-relaxed text-[#33322E]">
        ...
        <section>
          ...
          <p>
            ...
            않고 개별 방문자를 식별할 수 없는 익명 데이터만 수집·처리됩니다. 이 외에
            개인정보 처리를 외부에 위탁하고 있지 않습니다. 향후 신고 처리 자동화 등을 위해
            추가로 외부 사업자(예: AI 분석 서비스)에 위탁하게 될 경우, 위탁 내용과 수탁자를
            사전에 이 방침에 반영하여 고지합니다.
          </p>
        </section>
